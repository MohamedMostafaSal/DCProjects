1-  Streamlining Employee Data
            Import employee and human resources data in CSV, Excel, and JSON format. Then merge it all into a single DataFrame, before cleaning it 
            and exporting my results into a single CSV file.
